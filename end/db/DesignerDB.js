...
module.exports = {
    ...
    //保存
    save(designer){
      var sql = "insert into cloth_designer values(null,'"+designer.name+"','"+designer.password+"','"+designer.gender+"','"+designer.birth+"','"+designer.tel+"',null,null)";
      console.log(sql);
      return pool.execute(sql);
    },
    save_personalImg(img,id){
      var sql = "update cloth_designer set img = '"+img+"' where id ="+id;
      console.log(sql);
      return pool.execute(sql);
    },
    //更新
