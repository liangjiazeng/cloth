								...
								<div class="agile_header_grid"> 
									...
									<div class="agile_social_banner">
										<ul class="agileits_social_list">
											...
											<li v-if="user_isLogin">
												<i aria-hidden="true" ><router-link :to="{path:'/login'}">退出登录</router-link></i>
											</li>
											<li v-if="user_isLogin">
												<i  aria-hidden="true"><router-link :to="{name:'MyInfor',params: {name: userName}}">个人中心</router-link></i>
											</li>
										</ul>
									</div>  
						                    ...
						                    <div class="box">
						                        ...
						                        <div class="box-content">
						                            <div class="box-inner-content">
						                                ...
						                                <span class="post">Web Developer</span>
						                                <ul class="icon">
						                                    <li><a class="fa fa-search" href="#" @click="to_by(item.id,userName)">定制</a>
						                                    </li>
						                                </ul>
						                            </div>
						                        </div>
...
export default {
  ...
  data () {
    return {
    	...
    	nanshen:[],
      	img:[],
      	ads:['../../static/广告1.jpg','../../static/广告2.jpg','../../static/广告3.jpg','../../static/广告4.jpg','../../static/广告5.jpg','../../static/广告6.jpg','../../static/广告9.jpg','../../static/广告8.jpg'],
      	activeIndex: '1',
        activeIndex2: '1'
    }
  },
	    ...
	    findNewCloth(){
	    	...
	    	axios.get('http://39.107.228.71:3000/clothes/findAll').then(({data})=>{
				for(var sb=0;sb<8;sb++){
					vm.newcloth[sb] = data[sb];
				}
				for(var sb=0;sb<4;sb++){
					vm.img[sb] = data[sb];
				}
				vm.newcloth = Array.from(vm.newcloth);
				console.log("vm.newcloth",vm.newcloth);
