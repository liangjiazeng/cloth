      ...
      <el-col :span="4">
        ...
        <el-col :span="24" >
         	...
         	<el-row>
         		<div class="content">
         		<!-- 用户信息管理-->
		        	<div class="personal" style="margin-left:15%" v-if="show_Personnal" >
		        		<h1>所有的用户</h1>
						<div class="cont">
							<el-table
						    :data="users"
		        	...
		        	<!--设计师管理模块-->
		        	<div class="notice" style="margin-left:15%" v-if="show_notice">
		        		<h1>所有的设计师</h1>
						<div class="cont">
							<el-table
						    :data="designers"
...
export default {
  ...
  methods:{
	...
	to_dalete_designer(){
		...
		axios.post('http://39.107.228.71:3000/designer/batchDelete',{ids:JSON.stringify(this.delete_designer.id)}).then((result)=>{
			this.findAllClothes();
		      this.findAllDesigners();
		      this.findAllUsers();
  			vm.$message({
  	...
  	to_update_desinger(){
  		...
  		axios.post('http://39.107.228.71:3000/designer/update',{from:JSON.stringify(this.update_designer)}).then((result)=>{
			console.log(result);
			this.$message({
              showClose: true,
              type: 'success',
  	...
  	toAdd(){
  		...
  		axios.post('http://39.107.228.71:3000/clothes/save',{add_clothfrom:JSON.stringify(this.add_clothfrom)}).then((result)=>{
  			vm.$message({
              showClose: true,
              type: 'success',
              message: '删除成功!'
	...
	to_update_user(){
		...
		var vm = this;
		axios.post('http://39.107.228.71:3000/user/update',{update_User:JSON.stringify(this.update_User)}).then((result)=>{
  			vm.$message({
              showClose: true,
              type: 'success',
              message: '修改成功!'
	...
	to_dalete_user(){
		...
		axios.post('http://39.107.228.71:3000/user/batchDelete',{ids:JSON.stringify(this.delete_user.id)}).then((result)=>{
			this.findAllClothes();
		      this.findAllDesigners();
		      this.findAllUsers();
  			vm.$message({
