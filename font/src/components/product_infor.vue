    ...
    <div class="container">
      ...
      <div class="product">
        ...
        <p><span>布料</span>
          ...
          <p><span>价格</span>${{product.price*order.number}}</p>
...
import axios from 'axios'
  ...
  async findCloth(){
      var vm = this;
      axios.post('http://39.107.228.71:3000/clothes/findById',{id:JSON.stringify(this.clothId)}).then((result)=>{
    ...
    findDesigner(){
        axios.post('http://39.107.228.71:3000/designer/findById',{id:JSON.stringify(this.product.designer_id)}).then((data)=>{
    ...
    shopping(){
      ...
      var vm = this;
      axios.post('http://39.107.228.71:3000/order/save',{order:JSON.stringify(this.order)}).then((result)=>{
